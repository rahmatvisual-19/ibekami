...
// Guards added: all DOM queries are checked before use to avoid errors on pages
// that don't have the product image input (e.g. dashboard home, partner pages, etc.)

var inputElement       = document.getElementById('gambar_produk');
var previewContainer   = document.getElementById('previewContainer');
var remainingImagesInput = document.getElementById('remainingImages');

// Only run product image logic if the input exists on this page
if (inputElement && previewContainer) {
    var currentFiles   = [];
    var remainingImages = remainingImagesInput
