                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <div class="page-header-title">
                                                <h3 class="m-b-10">Ibeka Machine List</h3>
                                            </div>
                                            <ul class="breadcrumb">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h4>Banner List</h4>
                                            <a href="{{ route('machine.add') }}" class="btn btn-primary">Add New Machine</a>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        @foreach ($machine as $row)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($row->image_url)
                                                                        <img src="{{ asset('storage/machine_picture/' . $row->image_url) }}" alt="" style="max-width: 150px; max-height: 150px;">
                                                                    @else
                                                                        <span>No Image</span>
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    <a class="btn drp-icon btn-outline-primary"
                                                                        href="{{ route('machine.edit', $row->id) }}"
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('machine.destroy', $row->id) }}"
                                                                                        method="POST">
                                                                                        @csrf
                                                                                        @method('DELETE')
                                                                                        <button type="submit"
